...
[![SimpleLogistics! (SLOG)][MOD:shd:latest]][MOD:forum] [![KSP version][KSP:shd]][KSP:url]  [![License][LIC:shd]][LIC:url]  
...
## By [`zer0Kerbal`][zer0Kerbal], originally by [`RealGecko`][realgecko]
...
[![KSP Mods - Simple Logistics](https://img.youtube.com/vi/cJjIAE0RoK0/0.jpg)](https://youtu.be/cJjIAE0RoK0)
...
>* ![中文][CN] Chinese (中文) courtesy of [tinygrox](https://github.com/tinygrox)
>* ![Deutsch][DE] German (Deutsch) courtesy of [malanok1](https://github.com/malanok1)
>* ![Español][ES] Spanish (Español) courtesy of [fitiales](https://github.com/fitiales)
>* ![Français][FR] French (Français) courtesy of [Google](google)
>* ![Italiano][IT] Italian (Italiano) courtesy of [Google](google)
>* ![日本語][JA] Japanese (日本語) courtesy of [Google](google)
>* ![한국어][KO] Korean (한국어) courtesy of [Google](google)
>* ![Norsk][NO] Norwegian (Norsk) courtesy of [Google](google)
>* ![Русский][RU] Russian (Русский) courtesy of [malanok1](https://github.com/malanok1)
>* ![Svenska][SW] Swedish (Svenska) courtesy of [Google](google)
...
*and it is true.*
<!-- mod links -->
[MOD:attr]: https://zer0kerbal.github.io/SimpleLogistics/Attributions "Attribution"
...
[MOD:forum]: https://forum.kerbalspaceprogram.com/index.php?/topic/191045-*/ "SimpleLogistics Forum Thread"
[MOD:issue]: https://github.com/zer0Kerbal/SimpleLogistics/issues "Issues"
[MOD:markt]: https://zer0kerbal.github.io/SimpleLogistics/Marketing "Marketing Slicks"
[MOD:notic]: https://zer0kerbal.github.io/SimpleLogistics/Notices "Notices"
...
<!--- mod -->
[MOD:shd:latest]: https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/zer0Kerbal/SimpleLogistics/master/json/mod.json

[CODE:shd]: https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/zer0Kerbal/SimpleLogistics/master/json/code.json

[MOD:pages:shd]: https://img.shields.io/badge/GitHub-Pages-white?style=plastic&labelColor=9cf&logoColor=181717&logo=github "GitHub IO"
<!--- mod provenance -->

[MOD:0:dnload]: https://spacedock.info/mod/1079
[MOD:0:source]: https://github.com/Real-Gecko/KSP-SimpleLogistics
[MOD:0:thread]: https://forum.kerbalspaceprogram.com/index.php?/topic/152345-*/
...
[LIC:shd]: https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/zer0Kerbal/SimpleLogistics/master/json/license.json "GPL-3.0"
...
<!--- release links -->
[CURSFG:url]: https://www.curseforge.com/kerbal/ksp-mods/SimpleLogistics "Curseforge"
...
Track progress: issues [here][MOD:issue] and projects [here](https://github.com/zer0Kerbal/SimpleLogistics/projects/) along with **[The Short List](https://github.com/users/zer0Kerbal/projects/27)**
