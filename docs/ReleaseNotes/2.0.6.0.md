...
<div style="border:0.5px solid #BADASS; background-color: lightgrey; color: #FF0000; text-align:center">compiled with: KSP 1.12.4 — .NET 4.6.1 — C# 5.0</div>
...
[Code:shd]: https://img.shields.io/badge/CODE-%3C.NET%204.6.1%3E%20%3CC%23%205.0%3E-darkblue?style=plastic&labelColor=66ccff "Code"
