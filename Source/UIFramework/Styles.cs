...
namespace SimpleLogistics
{
	internal class Styles
	{
		...
		internal static void InitStyles() {
			...
			textArea.name = "SLSTextArea";

			textArea.wordWrap = true;

			// Button style
			button = new GUIStyle (textCommon);
			button.name = "SLSButton";
...
//			window.normal.background = Palette.tGray30;
			...
			horizontalSlider.name = "SLSHorizontalSlider";
			...
			horizontalSliderThumb.name = "SLSHorizontalSliderThumb";
...
//			horizontalSliderThumb.hover.background = Palette.tGray40;
			...
			verticalSlider.name = "SLSVerticalSlider";
			...
			verticalSliderThumb.name = "SLSVerticalSliderThumb";
			...
			horizontalScrollbar.name = "SLSHorizontalScrollbar";
			...
			horizontalScrollbarThumb.name = "SLSHorizontalScrollbarThumb";
			...
			horizontalScrollbarLeftButton.name = "SLSHorizontalScrollbarLeftButton";

			// Horizontal scrollbar right button
			horizontalScrollbarRightButton = new GUIStyle ();
			horizontalScrollbarRightButton.name = "SLSHorizontalScrollbarRightButton";

			// Vertical scrollbar
			verticalScrollbar = new GUIStyle();
			verticalScrollbar.name = "SLSVerticalScrollbar";
			...
			verticalScrollbarThumb.name = "SLSVerticalScrollbarThumb";
			...
			verticalScrollbarUpButton.name = "SLSVerticalScrollbarUpButton";

			//verticalScrollbarDownButton
			verticalScrollbarDownButton = new GUIStyle ();
			verticalScrollbarDownButton.name = "SLSVerticalScrollbarDownButton";

			// Scrollview style
			scrollView = new GUIStyle(textCommon);
			scrollView.name = "SLSScrollView";
			...
			selectionGrid.name = "SLSSelectionGrid";
